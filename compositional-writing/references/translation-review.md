...
可操作判準是**鄰詞存在測試**：原文語言存在一個量級更強的專詞、而原文沒有選用它、代表原文停在較低量級——譯文選了目標語言中對應那個更強量級的詞、就是超譯。實例：某產品登入成功頁的英文標語「Build something great」、日文在地化「素晴らしいものを作りましょう」量級對位（素晴らしい 對 great、同為日常高強度讚美）；把日文句再交給 AI 中譯、得到「讓我們製造一點奇蹟吧」——日文有「奇跡」這個常用專詞、日文版沒選用它、中譯選「奇蹟」等於替上游做了一個它明確沒做的選擇。同語言轉述用同一個測試：原文寫「暗示」（suggests）而轉述寫「證明」、就是替原文換上它沒選的強詞。
